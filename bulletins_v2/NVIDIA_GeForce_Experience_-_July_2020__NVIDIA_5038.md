...
| --- | --- | --- | --- |
| CVE‑2020‑5964 | NVIDIA GeForce Experience software contains a vulnerability in the service host component, in which the integrity check of application resources may be missed. Such an attack may lead to code execution, denial of service or information disclosure. | 6.5 | [AV:L/AC:L/PR:H/UI:R/S:U/C:H/I:H/A:](https://nvd.nist.gov/vuln-metrics/cvss/v3-calculator?vector=AV:L/AC:L/PR:H/UI:R/S:U/C:H/I:H/A:H)[H](https://cwe.mitre.org/data/definitions/570.html) |
...
| --- | --- | --- |
| 1.0 | July 7, 2020 | Initial release |
